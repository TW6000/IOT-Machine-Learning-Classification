...
file_path = "wrist_data_run_walk_aggregation_settings.csv" 
...
# We need to add the actual data from Consolidated all Group Member running & walking - and compare this to the training set
